...
Hooks.on("ready", async () => {
  if (!game.settings.get("expanse", "initial-welcome")) {
    ...
    <img src="systems/expanse/ui/The expanse RPG logo - black.webp" width="350px" height="62px" style="margin-bottom: 10px;">
    ...
    <br><br><img src="systems/expanse/ui/earth-5.webp" width="25px" height="25px"><br>
    ...
    <p><i>The Expanse Roleplaying Game</i> is ©2019 Green Ronin Publishing, LLC. All rights reserved. First Printing. References to other copyrighted material
            ...
            <div class="popup-img"><img src="systems/expanse/ui//roninlogo02_color300.webp" width="69" height="120" />    <img src="systems/expanse/ui/AGE_logo_Expanse.webp" width="161" height="100" /></div>
    </p></div>`,
      buttons: {
        dont_show: {
